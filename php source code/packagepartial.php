  ...
  <tr>
	...
	<table width="100%" height="100%" border="0">
      ...
      <tr>
	   ...
	   <tr>
        <td>&nbsp;</td>
        <td colspan="2"><div align="left"><strong>Total Package : </strong></div></td>
        <td colspan="3"><input name="txtkg" type="text" id="txtkg" onfocus="blur();" value="<?php print "$tpackage";?>"/></td>
      </tr>
	  <tr>
        <td>&nbsp;</td>
        <td colspan="2"><div align="left"><strong>Partial Package : </strong></div></td>
        <td colspan="3"><input name="txtppackage" type="text" id="txtppackage"/></td>
      </tr>
	  <tr>
        <td>&nbsp;</td>
...
$tpartial=$sqlresult + $pkg*/
 ...
 $rad1="no";
 $rad2="yes";
$result1="INSERT INTO `tab_automation` ( `port_of_entry` , `dep_date` , `checking_point` , `arr_date` , `importer_name` , `dec_reg_no` , `total_kg` ,  `total_package` , `ispartial` , `partial_kg` , `partial_package` , `ispartialp` , `goods_description` , `truck_plate_number` , `contr_nbr1` , `seal_nbr1` , `contr_nbr2` , `seal_nbr2` , `officer_name` ,  `system_time` ,  `remark` ) 
VALUES ('$port', '$idate', '$checkingp', '$adate', '$importer', '$concaa', '$tkg' , '$tpackage' , '$rad1' , '$pkg' , '$pkg1' ,  '$rad2' , '$goods', '$plate', '$cont1', '$seal1', '$cont2', 'seal2', '$officer', NOW(),'$remark')" ;

$sql2=mysql_query($result1);
if ($sql2)
{

echo "<p align=\"center\"><h3>Your Insertion has been done Successfully!</h3></p><a href=\"search.php\">Go to Search Form</a> $tppartial <br> ";
